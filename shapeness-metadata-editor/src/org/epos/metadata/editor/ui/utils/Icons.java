...
import org.epos.metadata.editor.ui.Activator;


public enum Icons {
	DELETE_NODE_ENABLED( "trash_enabled", path( "enabled/trash.png" ) ),
	DELETE_ALLNODES( "remove_all_nodes", path( "enabled/removeall.png" ) ),
	RENAME_NODEID_ENABLED( "rename_nodeID_enabled", path( "enabled/renameNode.gif" ) ),
	INFO_TERM( "info_term", path( "help_contents.png" ) ),
	INFO_DIALOG( "info_dialog", path( "info_tsk@2x.png" ) ),
	NEW_PROJECT( "new_projet", path( "new_wiz.png" ) ),
	NEW_PROJECT_WIZ( "new_projet_wiz", path( "new_wizard.png" ) ),
	NODE( "node", path( "node.png" ) ),
	EDGE( "edge", path( "edge.png" ) ),
	ZOOMOUT( "zoomout", path( "zoomminus.gif" ) ),
	ZOOMIN( "zoomin", path( "zoomplus.gif" ) ),
	PROPERTIES( "properties", path( "table.gif" ) ),
	GRAPH_LAYOUT( "layout", path( "graph_layout.gif" ) ),
	RECTANGLES_NODE( "rectangle", path( "rectangle16.gif" ) ),
	CLASS("class", path("newclass_wiz.png")),
	DATE_TIME("datetime", path("date_time.png")),
	PALETTE("palette", path("palette.png")),
	DUPLICATE_NODE("duplicate", path("duplicate.png")),
	PALETTE_CURSOR("palette-mouse-cursor", path("palette-mouse-cursor.png")),
	DESELECT_ALL_FILTERS("deselect_all_filters", path("deselect_all_filters.png")),
	SELECT_ALL_FILTERS("select_all_filters", path("select_all_filters.png")),
	TERM_DEFINITION("term_definition", path("term_definition.png")),
	REMOVE("remove", path("remove.png")),
	GIT_PUSH("git_push", path("push_wizban.png")),
	EYE_ENABLED("eye-enable", path("eye-enable.png")),
	EYE_DISABLED("eye_disable", path("eye_disable.png")),
	IMPORT_DOI("import_doi", path("importDOI.gif")),
    ...
    // edit actions
    DELETE_NODE_ENABLED( "delete_enabled", path( "enabled/delete.gif" ) ),
