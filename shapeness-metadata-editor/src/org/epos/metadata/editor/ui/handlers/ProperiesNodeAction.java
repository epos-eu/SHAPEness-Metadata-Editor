...
public class ProperiesNodeAction extends AbstractHandler {
			...
			if(!DataManager.getIstance().getNodes().isEmpty()) {
				...
				if(!selection.isEmpty()) {
					...
					if(objSelected instanceof Node) {
						...
						MessageDialog.openWarning(Display.getDefault().getActiveShell(), "Warning", "You should select a node to visualise the properties table.");
